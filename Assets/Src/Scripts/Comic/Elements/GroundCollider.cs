    ...
    public class HalfHeightCollider : MonoBehaviour
    {
        ...
        private void OnValidate()
        {
            if (!Application.isPlaying)
            {
                ...
                collider.offset = new Vector2(0f, -bounds.extents.y / transform.lossyScale.y + halfHeight / 2f);

                // Mark scene as dirty so the change saves
                EditorUtility.SetDirty(collider);
                Debug.Log("half height collider");
            }
        }
#endif
    }
