...
//        private URP_CameraManager m_cameraManager;
        ...
        //{
        //    yield return StartCoroutine(m_hudPageMgr.TurningPageCoroutine(next_page, page_bounds, ComicCinemachineMgr.Instance.MainCamera, duration));
        //}

        //public IEnumerator TurnPageError(bool next_page, Bounds page_bounds, float duration)
        //{
        //    yield return StartCoroutine(m_hudPageMgr.TurningPageErrorCoroutine(next_page, page_bounds, ComicCinemachineMgr.Instance.MainCamera, duration));
        //}
